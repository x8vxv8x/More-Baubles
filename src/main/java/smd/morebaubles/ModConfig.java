...
import smd.morebaubles.util.Config.EnumPropSide;
...
public class ModConfig {
	...
	public static void initConfig() {
		recipesEnabled = morebaubles.config.addPropBoolean("defaultRecipesEnabled",
				CAT_GENERAL,
		...
		brewingRecipesEnabled = morebaubles.config.addPropBoolean(
				...
				true, EnumPropSide.SERVER);
		Property anvilRecipesEnabledLocal = morebaubles.config.addPropBoolean(
		...
		mobLootEnabled = morebaubles.config.addPropBoolean("defaultMobLootEnabled",
				CAT_GENERAL,
				...
				true, EnumPropSide.SERVER);
		dungeonLootEnabled = morebaubles.config.addPropBoolean("defaultDungeonLootEnabled",
				CAT_GENERAL,
				...
				true, EnumPropSide.SERVER);
		spectralSiltEnabled = morebaubles.config.addPropBoolean("spectralSiltEnabled",
				CAT_GENERAL, "Whether dungeon item recycling is enabled.", true,
				EnumPropSide.SERVER);
		spectralSiltRecipesEnabled = morebaubles.config.addPropBoolean(
				...
				true, EnumPropSide.SERVER);
		Property baubleModifiersEnabledLocal = morebaubles.config.addPropBoolean(
				...
				true, EnumPropSide.SYNCED);
		randomBaubleModifiersEnabled = morebaubles.config.addPropBoolean(
		...
		reforgeCostMin = morebaubles.config.addPropInt("reforgeCostMin", CAT_GENERAL,
				"Minimum XP point cost to reforge an item in the reforger", 80, EnumPropSide.SERVER,
				1, Integer.MAX_VALUE/100);

		reforgeCostMax = morebaubles.config.addPropInt("reforgeCostMax", CAT_GENERAL,
		...
		anvilRecipesEnabled = morebaubles.config
				.getSyncedProperty("defaultAnvilRecipesEnabled");
		baubleModifiersEnabled = morebaubles.config
