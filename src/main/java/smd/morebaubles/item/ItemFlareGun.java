...
public class ItemFlareGun extends GenericItemBB {
	...
	public ItemFlareGun() {
		super("flareGun", morebaubles.TAB);
		this.maxStackSize = 1;
	}
	...
	public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player,
		...
		if (!world.isRemote) {
//			morebaubles.logger.info("spawning flare");
	...
	public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip,
		...
		if (!morebaubles.isAlbedoLoaded) {
			tooltip.add(morebaubles.proxy.translate(getTranslationKey()+".tooltip.noalbedo"));
		}
	}
}