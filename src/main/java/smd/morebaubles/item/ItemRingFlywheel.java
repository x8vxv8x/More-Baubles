...
//		rfCapacity = capacity;
		...
		Property unsynced = morebaubles.config.addPropInt(getRegistryName()+".charge", "Items",
		...
		rfCapacity = morebaubles.config.getSyncedProperty(getRegistryName()+".charge");
	}
...
//		morebaubles.logger.info(rfCapacity.getInt());
//		IEnergyStorage e = stack.getCapability(ENERGY_STORAGE_CAPABILITY, null);
//		if (e!=null) {
//			morebaubles.logger.info(e.getMaxEnergyStored());
//		}
	}
	...
	public static class Provider implements ICapabilitySerializable<NBTTagCompound> {
		...
		public static final ResourceLocation NAME = new ResourceLocation("morebaubles",
				"energy_storage");
