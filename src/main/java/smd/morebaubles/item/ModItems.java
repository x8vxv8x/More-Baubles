...
import smd.morebaubles.item.throwable.ItemBeenade;
import smd.morebaubles.item.throwable.ItemGrenade;
...
public class ModItems {
	...
	public static void registerToRegistry() {
		...
		morebaubles.registryHelper.addItem(ringOverclocking = new ItemRingOverclocking());
		...
		morebaubles.registryHelper.addItem(magicMirror = new ItemMagicMirror("magicMirror"));
		morebaubles.registryHelper.addItem(potionRecall = new ItemPotionRecall());
		morebaubles.registryHelper
				.addItem(wormholeMirror = new ItemWormholeMirror("wormholeMirror"));
		morebaubles.registryHelper.addItem(potionWormhole = new ItemPotionWormhole());
		...
		morebaubles.registryHelper.addItem(crownGold = new ItemArmorBB("crownGold",
				"crownGold", crownGoldMat, EntityEquipmentSlot.HEAD, morebaubles.TAB));
		morebaubles.registryHelper.addItem(sinPendantPride = new ItemAmuletSinPride());
		morebaubles.registryHelper.addItem(sinPendantWrath = new ItemAmuletSinWrath());

		morebaubles.registryHelper.addItem(trinketBrokenHeart = new ItemTrinketBrokenHeart());

		morebaubles.registryHelper.addItem(amuletCross = new ItemAmuletCross());

		morebaubles.registryHelper.addItem(phantomPrism = new ItemPhantomPrism());
