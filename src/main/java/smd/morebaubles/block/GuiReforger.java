...
import smd.morebaubles.util.Util;
import smd.morebaubles.util.XpUtil;
...
public class GuiReforger extends GuiContainer {
	...
	public void initGui() {
		...
		GuiBetterButton button = new GuiBetterButton(0, guiLeft+10, guiTop+26, 85, 16,
				morebaubles.proxy.translate(tranStr+"reforge"));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (stack.hasTagCompound()) {
			...
			String xpCostStr = morebaubles.proxy.translate(tranStr+"xpcost");
			String levelsStr;
			if (morebaubles.proxy.hasTranslationKey(tranStr+"levels.override."+levelCost)) {
				levelsStr = morebaubles.proxy
