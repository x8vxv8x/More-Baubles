...
public class ModLoot {
	...
	public static void initConfig() {
		dungeon_baseRate = morebaubles.config.addPropDouble("dungeon_base", ModConfig.CAT_LOOT,
				"Chance of a morebaubles item spawning in a dungeon chest "
						+"(excluding recall/wormhole potions). 0 to disable.",
				0.35D, EnumPropSide.SERVER, 0D, 1D);
		dungeon_potionRate = morebaubles.config.addPropDouble("dungeon_potion",
				ModConfig.CAT_LOOT,
				"Chance of recall or wormhole potions spawning in a dungeon chest. 0 to disable.",
				0.75D, EnumPropSide.SERVER, 0D, 1D);
		wormholeEnabled = morebaubles.config.addPropBoolean("wormhole", ModConfig.CAT_LOOT,
		...
		nether_baseRate = morebaubles.config.addPropDouble("nether_base", ModConfig.CAT_LOOT,
				"Chance of a morebaubles item spawning in a nether fortress chest "
						+"(excluding recall/wormhole potions). 0 to disable.",
				0.2D, EnumPropSide.SERVER, 0D, 1D);
		nether_potionRate = morebaubles.config.addPropDouble("nether_potion",
				ModConfig.CAT_LOOT,
...
//				morebaubles.logger.info("baseRate: "+baseRate);
				if (baseRate>0) {
...
//							new LootCondition[0], Tags.MOD_ID+":goldring"));
	...
	public static void onEntityTick(LivingUpdateEvent event) {
		if (ModConfig.mobLootEnabled
				.getBoolean(true)/* &&!morebaubles.isQuarkLoaded */
			...
			if (dragon.deathTicks==199) {
				morebaubles.logger.info(dragon.world.restoringBlockSnapshots);
