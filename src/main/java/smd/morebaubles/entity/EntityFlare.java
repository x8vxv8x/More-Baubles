...
//		morebaubles.logger.info("flare shot");
	}
...
//		morebaubles.logger.info("reading from nbt "+compound.toString());
...
//			morebaubles.logger.info(this.posX+" "+this.posY+" "+this.posZ);
//		}
...
//			morebaubles.logger.info("entity tick");
//		}
